...
# 사용자가 파일을 업로드하기 전 표시될 안내 텍스트
# 이 부분은 'if uploaded_file:' 블록 외부에 위치하여 파일 업로드 전에 항상 보입니다.
if not uploaded_file:
    st.markdown("""
    ### 사용방법 안내
    
    안녕하세요! **현금흐름 대시보드**에 오신 것을 환영합니다.
    이 대시보드는 엑셀 파일을 분석하여 회사 현금흐름을 시각화하고 중요한 정보를 한눈에 파악할 수 있도록 돕습니다.
    
    1.  ERP 계정별원장에서 '현금및현금등가물'을 선택하고 회계일자 범위를 지정합니다.
    2.  관리항목조회여부(Yes), 관리항목코드포함(Yes)으로 설정한 뒤 조회합니다.
    3.  엑셀 내보내기>엑셀 내보내기(화면,숨김 컬럼 포함)으로 데이터를 다운로드합니다.
    4.  다운받은 엑셀 파일을 왼쪽 사이드바에 업로드합니다.
    
    분석 결과는 **현금잔액 현황**, **월별 현금 잔액 및 지출 추이**, **월별 수입/지출 항목별 비중** 등으로 구성되어 있습니다.
    이제 파일을 업로드하여 현금흐름 데이터를 확인해 보세요!
    """)
...
cash_flow_mapping = {
    1110: '제품매출', 1120: '상품매출', 1130: '용역매출', 1140: '수출대금', 1990: '기타수입',
    2110: '이자수입', 2120: '영업외수입', 2130: '예적금만기', 2140: '대여금 회수', 2150: '출장비 반납', 2990: '기타영업외수입',
    3110: '자산매각', 3120: '차입금/사채조달', 5110: '상품구입',
    5120: '원부자재구매', 5220: '인건비', 5310: '일반경비', 5340: '퇴직연금 불입', 5990: '기타영업지출',
    6110: '차입금 이자지급', 6120: '배당금지급', 6130: '세금납부', 6140: '대여금지급', 6210: '법인세 납부',
    6990: '기타영업외지출',
...
if uploaded_file:
    try:
        ...
        classification_mapping = {
            '제품매출': '수입', '상품매출': '수입', '용역매출': '수입', '수출대금': '수입', '기타수입': '수입',
            '이자수입': '수입', '영업외수입': '수입', '예적금만기': '수입', '대여금 회수': '수입', '자산매각': '수입', '출장비 반납': '수입', '기타영업외수입': '수입',
            '차입금/사채조달': '수입', '상품구입': '지출', '원부자재구매': '지출', '인건비': '지출',
            '일반경비': '지출', '퇴직연금 불입': '지출', '차입금 이자지급': '지출', '배당금지급': '지출', '기타영업지출': '지출',
            '세금납부': '지출', '대여금지급': '지출', '법인세 납부': '지출', '자산매입': '지출', '기타영업외지출': '지출',
